...
extern int convert_midi_control_change(int chn, int type, int val, MidiEvent *ev_ret);
...
extern struct midi_file *open_midi_file(char *name, int decompress, int noise_mode);
